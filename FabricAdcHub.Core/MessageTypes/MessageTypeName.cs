...
namespace FabricAdcHub.Core.MessageTypes
{
    public sealed class MessageTypeName
    {
        ...
        public static readonly MessageTypeName Direct = new MessageTypeName('D');
        ...
        {
            var validTypes = new[] { Broadcast, Direct, Echo, Information, FeatureBroadcast, ForHub, DirectTcp, DirectUdp };
